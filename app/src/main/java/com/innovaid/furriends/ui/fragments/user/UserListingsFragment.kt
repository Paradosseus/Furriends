...
class UserListingsFragment : BaseFragment() {
    ...
    private fun getPetsListFromFireStore() {
        showProgressDialog(resources.getString(R.string.please_wait))
        FirestoreClass().getPetsList(this@UserListingsFragment)
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (id) {
            R.id.actionAddPet -> {
                startActivity(Intent(activity, AddUserPetProfileActivity::class.java))
                return true
            }
        }
